...
file_paths = ["credit_card_transactions.csv", "online_purchase_transactions.csv", "money_transfer_transactions.csv"]
...
incoming_transactions_scaled = preprocess_incoming_data(incoming_transactions, scaler)
...
suspicious_transactions = incoming_transactions[(rf_predictions == 1) | (svm_predictions == -1)]
